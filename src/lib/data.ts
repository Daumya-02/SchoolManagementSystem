...
// Get all weekdays of current week
...
const [monday, tuesday, wednesday, thursday, friday] = weekDays;
...
// Events are dynamically set to the current week
